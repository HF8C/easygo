...
$INS=  mysql_query("Insert into tb_user (regname,regrealname,regpwd,regbirthday,regemail,regcity,regico,regsex,regqq,reghomepage,regsign,regintroduce,ip,fig)"
        ."Values ('$regname,'$regrealname','$repwd','$regbirthday','$regemail','$regcity','$regico','$regsex','$regqq','$reghomepage','$regsign','$regintroduce','$ip',0)"
        );
echo "<script>alert('用户注册成功！');</script>";
echo "<script>window.location='myblog.php'</script>";
